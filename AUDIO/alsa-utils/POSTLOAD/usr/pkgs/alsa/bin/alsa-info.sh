...
PATH=$PATH:/usr/pkgs/pciutils/bin:/usr/pkgs/alsa/bin:/usr/pkgs/usbutils/bin:/usr/pkgs/coreutils/bin:/usr/pkgs/util-linux/bin:/usr/bin
BGTITLE="ALSA-Info v $SCRIPT_VERSION"
PASTEBINKEY="C9cRIO8m/9y8Cs0nVs0FraRx7U0pHsuc"
#Define some simple functions

WGET=$(/usr/pkgs/which/bin/which wget 2>/dev/null| sed 's|^[^/]*||' 2>/dev/null)
